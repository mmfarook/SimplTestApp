...
public class SimplTextView extends AppCompatTextView {
    private static final String TAG = "SimplTextView";

    public SimplTextView(Context context) {
        super(context);
    }

    public SimplTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setCustomFont(context, attrs);
    }

    public SimplTextView(Context context, AttributeSet attrs, int defStyleAttr) {
